...
export class DealersController {
  static getAll = async (req, res) => {
    try {
      ...
      if (email) {
        const dealers = await DealersModel.getByEmail({
          email
        });
  ...
  static getById = async (req, res) => {
    try {
      ...
      const dealer = await DealersModel.getById({
        id
      });
      res.json(dealer);
    } catch (error) {
  ...
  static create = async (req, res) => {
    ...
    try {
      const newDealer = await DealersModel.create({
        input: input.data
      });
  ...
  static delete = async (req, res) => {
    ...
    const deletedDealer = await DealersModel.delete({
      id
    });
  ...
  static update = async (req, res) => {
    ...
    try {
      const updatedDealer = await DealersModel.update({
        id,
        input
      });
