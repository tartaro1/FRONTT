...
export class DetailsController {
  static getAll = async (req, res) => {
    try {
      ...
      if (provider) {
        const detailsOrdersFiltred = await DetailsModel.getByProvider({
          provider
        });
  ...
  static getOrderProducts = async (req, res) => {
    try {
      ...
      const detailsOrder = await DetailsModel.getOrderProducts({
        id
      });
  ...
  static delete = async (req, res) => {
    try {
      ...
      const productsDetails = await DetailsModel.delete({
        id
      });
  ...
  static update = async (req, res) => {
    try {
      ...
      const productsDetails = await DetailsModel.update({
        id,
        input
      });
      res.json(productsDetails);
